...
class SettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btSupport.setOnClickListener {
            ...
            techSupportIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf(getString(R.string.tech_support_email)))
            techSupportIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.tech_support_email_title))
            techSupportIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.tech_support_email_message))
